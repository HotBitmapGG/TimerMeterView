package com.hotbitmapgg.timer.wheel;
...
import com.hotbitmapgg.timer.adapters.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    private void initData(Context context)
    {
        ...
        mPaintLineRight.setColor(context.getResources().getColor(android.R.color.transparent));
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    private void initResourcesIfNecessary()
    {
        ...
        setBackgroundResource(R.color.view_bg);
    }
